...
def Display_search(Search_record):  # To Display Searched Record
    try:
        data = []
        header = [cell.value for cell in admin.sheet_obj[1]]
        for row in Search_stocks(Search_record):
